...
class YaimportControllercategories extends JControllerLegacy{
    ...
    function display($cachable = false, $urlparams = false){
        ...
        $categories = $_categories->getTreeAllCategories($filter, $filter_order, $filter_order_Dir, $filter_related);
