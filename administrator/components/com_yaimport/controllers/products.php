...
class YaimportControllerProducts extends JControllerLegacy{
    ...
    function display($cachable = false, $urlparams = false){    
        ...
        //$products_related = $this->getModel("relates");
        ...
        $filter_related = $mainframe->getUserStateFromRequest($context.'retaled_filter', 'retaled_filter', 0, 'int');
        ...
        $rows = $products->getAllProducts($filter, $pagination->limitstart, $pagination->limit, $filter_order, $filter_order_Dir, $filter_related);
		
		//$rows_relates = $products_related->getAllRelates();
        ...
        foreach($rows as $key=>$v){
			...
			/*if(isset($rows_relates[$v->product_id]))
			{
				$rows[$key]->yandex_id = $rows_relates[$v->product_id];
			}*/
        }
        ...
        $view->assign('filter_related', $filter_related);        
